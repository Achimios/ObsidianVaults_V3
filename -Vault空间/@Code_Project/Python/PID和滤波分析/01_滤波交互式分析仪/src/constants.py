...
DARK_THEME  = dict(
        ...
        noise='#253048',      # 时域 sp 线（Setpoints+噪音输入信号）颜色
        noise_psd='#555575',  # PSD 图 输入功率谱曲线颜色
        ...
        pal_win="#0e1421", pal_btn="#162437", pal_txt='#e0e0f0',
...
LIGHT_THEME = dict(
        ...
        tick='#1a2030', label='#1a2030', title="#0e1423",
        href='#b8c8d4', href2='#d0dce4',
        band='#c8e4f4', xmark='#7aaec4',
        pt1="#357fad", lkf="#cc1020",
        noise='#a4b8c8',      # 时域 sp 线（Setpoints+噪音输入信号）颜色
        noise_psd='#8898a8',  # PSD 图 输入功率谱曲线颜色
